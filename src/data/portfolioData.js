...
export const portfolioData = {
  ...
  about: {
    description: "Final-year BEng (Hons) Software Engineering undergraduate at APIIT and Associate Software Engineer at Enfection Pvt Ltd. Passionate about creating innovative digital solutions that blend functionality, performance, and user experience.",
  ...
  experience: [
    {
      ...
      type: "Full-time",
      description: "Developed custom WordPress websites, built React applications, and managed cloud hosting environments. Led project coordination and team assignments while ensuring timely delivery of high-quality solutions.",
      achievements: [
      ...
      technologies: ["React.js", "Node.js", "Express.js", "WordPress", "PHP", "AWS", "cPanel", "Sass", "ACF"]
    },
    {
      ...
      type: "Internship",
      description: "Contributed to front-end development of the company's career website, focusing on enhancing user experience and implementing responsive design patterns.",
      achievements: [
  ...
  "description": "AI-powered learning assistant designed for A/L teachers and students to enhance finance education through interactive and intelligent guidance.",
  ...
  "images": [
    "public/images/acca.png"
  ]
},

    {
  "title": "Avyanna Hotel Maldives",
  "description": "Modern, responsive hotel website with third-party booking integration, multilingual support, and custom CMS features built using WordPress and PHP.",
  ...
  "technologies": ["WordPress", "PHP", "MySQL", "JavaScript", "HTML5", "ACF", "Sass", "SwiftBook", "Google Translate Plugin"],
  "achievements": [
  ...
  "images": [
    "public/images/avyanna.png"
  ]
}
,
    {
  "title": "IEC Sri Lanka Website",
  "description": "Professional educational consultancy website providing information on international programs, universities, and application guidance.",
  "longDescription": "Developed a modern and responsive website for IEC Sri Lanka, an educational consultancy that helps students explore and apply to international study programs. The site includes course information pages, inquiry forms, contact options, and CMS features powered by WordPress and ACF for easy content updates.",
  ...
  "demo": "https://iec.lk/",
  "images": [
    "public/images/iec.png"
  ]
},
{
  "title": "Seville",
  "description": "Modern business website for a premier construction company showcasing services, projects, and company profile.",
  ...
  "images": [
    "public/images/seville.png"
  ]
},
{
  "title": "PMF",
  "description": "Corporate website for PMF Group highlighting their services, expertise, and client-focused solutions.",
  ...
  "images": [
    "public/images/pmf.png"
  ]
},
{
  "title": "Brandix Intranet Portal",
  "description": "Secure internal intranet system for Brandix employees to access organizational resources, updates, and tools.",
  ...
  testimonials: [
    {
      ...
      company: "Enfection Pvt Ltd",
      content: "Sandushi is an exceptional developer who consistently delivers high-quality work. Her attention to detail and problem-solving skills make her a valuable team member.",
      rating: 5,
    ...
    },
    {
      ...
      company: "Gamage Recruiters Pvt Ltd",
      content: "Working with Sandushi was a pleasure. She perfectly translated our design concepts into functional, responsive websites. Her technical expertise and collaborative approach made our project a success.",
      rating: 5,
    ...
    },
    {
      ...
      content: "Sandushi's full-stack development skills are impressive. She delivered our e-commerce platform on time and exceeded our expectations. Her code quality and documentation are top-notch.",
      rating: 5,
    ...
    },
    {
      ...
      content: "Sandushi's ability to understand business requirements and translate them into technical solutions is remarkable. She's proactive, communicative, and always goes the extra mile.",
      rating: 5,
  ...
  services: [
    {
      ...
      technologies: ["React.js", "Node.js", "Express.js", "MongoDB", "AWS", "Docker"]
    },
    {
      title: "WordPress Development",
      description: "Custom WordPress theme and plugin development with modern design and functionality.",
      icon: "🎨",
      features: [
    ...
    },
    {
      ...
      description: "Intelligent applications using computer vision, NLP, and machine learning technologies.",
      icon: "🤖",
      features: [
      ...
      technologies: ["Python", "PyTorch", "TensorFlow", "OpenCV", "NLP", "OpenAI API"]
    },
    {
      title: "Cloud & DevOps Services",
      description: "Cloud infrastructure setup, deployment automation, and DevOps practices implementation.",
      icon: "☁️",
      features: [
  ...
  blog: [
    {
      ...
      excerpt: "Learn how to design and implement microservices architecture using Spring Boot and containerization.",
      date: "2024-05-15",
      readTime: "8 min read",
    ...
    },
    {
      ...
      excerpt: "Exploring how computer vision and LLMs are revolutionizing automated testing methodologies.",
      date: "2024-04-20",
    ...
    },
    {
      ...
      excerpt: "Essential strategies for optimizing React applications and improving user experience.",
      date: "2024-03-10",
      readTime: "6 min read",
  ...
  seo: {
    ...
    description: "Experienced Full-Stack Developer specializing in React.js, Node.js, and WordPress development. Building innovative web solutions in Sri Lanka.",
    keywords: [
