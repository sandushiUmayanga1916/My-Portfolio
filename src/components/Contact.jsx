        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          ...
          >
            <div className="space-y-4">
              ...
              <a href={`mailto:${portfolioData.personal.email}`} target="_blank" rel="noopener noreferrer" className="block mb-4">
              ...
              <a href={`tel:${portfolioData.personal.phone}`} target="_blank" rel="noopener noreferrer" className="block mb-4">
                <motion.div className="glass-effect rounded-xl p-6 flex items-center gap-4" whileHover={{ scale: 1.02, x: 10 }}>
                  <div className="w-12 h-12 bg-gradient-to-r from-primary-500 to-purple-600 rounded-full flex items-center justify-center">
              ...
              <a href={portfolioData.personal.github} target="_blank" rel="noopener noreferrer" className="block mb-4">
                <motion.div className="glass-effect rounded-xl p-6 flex items-center gap-4" whileHover={{ scale: 1.02, x: 10 }}>
                  <div className="w-12 h-12 bg-gradient-to-r from-primary-500 to-purple-600 rounded-full flex items-center justify-center">
              ...
              <a href={portfolioData.personal.linkedin} target="_blank" rel="noopener noreferrer" className="block mb-4">
                <motion.div className="glass-effect rounded-xl p-6 flex items-center gap-4" whileHover={{ scale: 1.02, x: 10 }}>
                  <div className="w-12 h-12 bg-gradient-to-r from-primary-500 to-purple-600 rounded-full flex items-center justify-center">
              ...
              <div className="space-y-6">
                ...
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-4 py-3 bg-dark-700/50 border border-gray-600 rounded-lg text-white focus:ring-2 focus:ring-primary-500 transition-all duration-300 disabled:opacity-50"
                ...
                <div>
                  ...
                  <textarea
                    ...
                    rows={5}
                    disabled={isSubmitting}
                    className="w-full px-4 py-3 bg-dark-700/50 border border-gray-600 rounded-lg text-white focus:ring-2 focus:ring-primary-500 transition-all duration-300 resize-none disabled:opacity-50"
                ...
                <motion.button
                  type="submit"
                  disabled={isSubmitting}
                  className="w-full bg-gradient-to-r from-primary-500 to-purple-600 text-white py-3 px-6 rounded-lg font-semibold flex items-center justify-center gap-2 hover:shadow-lg transition-all duration-300 disabled:opacity-50"
